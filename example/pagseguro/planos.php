...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        $response = $pagseguro->recurrence('EB9E97B14F4F1BE6642F3F85147F11AD', 'IDPEDIDO1', $customer, $shipping, $payment);
        echo $response;
    } catch (Exception $e) {
        var_dump($e);
    } catch (Error $e) {
...
<form id="form" action="" method="post">
    ...
    <input type="text" id="year" name="year" value="1990" class="percent-50"><br>
